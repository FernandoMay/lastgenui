...
// import 'package:SizedBox/SizedBox.dart';
// import 'package:provider/provider.dart';
      ...
      children: [
        ...
        Row(
          ...
          children: [
            ...
            Image.asset("assets/select-left.png", height: 65),
            Text('57', style: TextStyles.h2),
            Image.asset("assets/select-right.png", height: 65),
          ],
            ...
            child: Stack(
              children: [
                ...
                if (selected) ...[
                  Positioned(
                    left: 0,
                    child: Image.asset("assets/select-left.png"),
                  ),
                  Positioned(
                    right: 0,
                    child: Image.asset("assets/select-right.png"),
                  ),
                ],
    ...
    return FocusableControlBuilder(
      ...
      builder: (_, state) {
        ...
        return SizedBox(
          ...
          child: Stack(
            children: [
              Positioned.fill(child: Image.asset("assets/button-start.png")),
              if (state.isHovered || state.isFocused) ...[
                Positioned.fill(
                    child: Image.asset("assets/button-start-hover.png")),
              ],
              Center(
                child: Row(
