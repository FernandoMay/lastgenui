...
import 'package:uilastgen/particles.dart';
import 'package:uilastgen/shader.dart';
import 'package:uilastgen/styles.dart';
import 'package:uilastgen/titleui.dart';
          ...
          child: _AnimatedColors(
            ...
            builder: (_, orbColor, emitColor) {
              return Stack(
                children: [
                  /// Bg-Base
                  Image.asset("assets/bg-base.jpg"),

                  /// Bg-Receive
                  _LitImage(
                    color: orbColor,
                    imgSrc: "assets/bg-light-receive.png",
                  ...
                  /// Mg-Receive
                  _LitImage(
                    imgSrc: "assets/mg-light-receive.png",
                    color: orbColor,
                    pulseEffect: _pulseEffect,
                    lightAmt: _finalReceiveLightAmt,
                  ),
                  ...
                  /// Mg-Emit
                  _LitImage(
                    imgSrc: "assets/mg-light-emit.png",
                    color: emitColor,
                    pulseEffect: _pulseEffect,
                  ...
                  /// Fg-Rocks
                  Image.asset("assets/fg-base.png"),

                  /// Fg-Receive
                  _LitImage(
                    imgSrc: "assets/fg-light-receive.png",
                    color: orbColor,
                    pulseEffect: _pulseEffect,
                    lightAmt: _finalReceiveLightAmt,
                  ),
                  ...
                  /// Fg-Emit
                  _LitImage(
                    imgSrc: "assets/fg-light-emit.png",
                    color: emitColor,
                    pulseEffect: _pulseEffect,
                    lightAmt: _finalEmitLightAmt,
                  ),
